...
let SanityCheckNugetPackages() =
    ...
    let GetSolution(solName: string) =
        let slnFile = Path.Combine(RootDir.FullName, solName) |> FileInfo
    ...
    sanityCheckNugetPackagesFromSolution (GetSolution "convention.sln")
